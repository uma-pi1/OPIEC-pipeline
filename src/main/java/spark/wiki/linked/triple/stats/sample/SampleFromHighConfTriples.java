...
public class SampleFromHighConfTriples {
    /**
    ...
    public static void main(String args[]) {
        ...
        JavaRDD<TripleLinked> highConfTriplesRDD = wikiTriplesLinkedPairRDD.map(tuple -> {
        ...
        // Take the sample
        List<TripleLinked> tripleSampleList = highConfTriplesRDD.takeSample(false, sampleSize);
