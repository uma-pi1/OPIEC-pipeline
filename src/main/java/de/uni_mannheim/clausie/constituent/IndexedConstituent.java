...
public class IndexedConstituent extends Constituent {
     ...
     * (unless they appear in {@link #root} or  additionalRoots). */
    ...
    public IndexedConstituent clone() {
        ...
        //XXX
        clone.processedConjunction = this.isProcessedConjunction();
        clone.conjWord = this.getConjWord();
        return clone;
    }
