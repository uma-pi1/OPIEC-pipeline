...
public abstract class Constituent {
    ...
    /** The root vertex of this constituent in semanticGraph. This vertex and all its
     * descendants are part of the constituent (unless they appear in excludedVertexes). */
